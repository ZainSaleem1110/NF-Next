...
function AuthNav() {
    return (
        <div className="bg-[#F1F4FB] w-full xl:py-10 py-5 xl:px-20 sm:px-10 px-5 justify-between flex">
            ...
            <div className="justify-between w-full lg:flex hidden">
                ...
                <div className="flex gap-5">
                    <button className="bg-[#AD7EFF] text-white px-8 rounded-xl font-semibold text-[18px]">Create Event</button>
